...
func ItoBoolDefault(value interface{}) bool {
	if value == nil {
		return false
	}
	v, err := value.(bool)
...
func ValuePTR(obj interface{}) interface{} {
	t := reflect.TypeOf(obj)
	if t.Kind() != reflect.Ptr {
		return to_struct_ptr(obj)
	}
	return obj
}
...
func StructToJson(i interface{}) (string, error) {
...
func ItoStruct(input *map[string]interface{}, output interface{}) error {
